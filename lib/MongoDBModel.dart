...
class MongoDbModel {
  ...
  factory MongoDbModel.fromJson(Map<String, dynamic> json) => MongoDbModel(
        id: json["_id"] is String ? ObjectId.fromHexString(json["_id"]) : json["_id"],
        ...
        typeoflesion: (json["typeoflesion"] as List<dynamic>?)?.map((e) => e.toString()).toList() ?? [],
        locationofswelling: (json["locationofswelling"] as List<dynamic>?)?.map((e) => e.toString()).toList() ?? [],
        imageBase64: json["imageBase64"] ?? '',
        clinicalsuspicion: (json["clinicalsuspicion"] as List<dynamic>?)?.map((e) => e.toString()).toList() ?? [],
        other: json["other"] ?? '',
